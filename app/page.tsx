...
const localWorkstationTests: EndpointTest[] = [
  ...
  },
  {
    ...
    command: [
      ...
      "    @{",
      '      role = "user"',
      '      content = "Complete this C# method with only the return statement: int Add(int a, int b)"',
      "    }",
      "  )",
      "  temperature = 0",
      "  max_tokens = 30",
    ...
    expected: "A result equivalent to:\nreturn a + b;",
    success: "The autocomplete model returns a valid C# completion.",
    failure: "Confirm that local-autocomplete is loaded and that the model supports the selected endpoint.",
  },
];
